...
@Composable
fun HumidityWindPressureRow(weather: Item0, isImperial: Boolean) {
    Row(
        modifier = Modifier
            .padding(12.dp)
            .fillMaxWidth(),
        ...
        Row(modifier = Modifier.padding(4.dp)) {
            ...
            Text(formatDecimals(weather.speed) +if (isImperial) "mph" else "m/s", style = MaterialTheme.typography.bodyMedium)
        }
